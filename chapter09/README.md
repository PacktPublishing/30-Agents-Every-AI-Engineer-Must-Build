...
|---|---|---|
| [EXAMPLE_RUN_SIMULATION_MODE_ch09_software_dev_agents.ipynb](EXAMPLE_RUN_SIMULATION_MODE_ch09_software_dev_agents.ipynb) | Simulation | Executed without an API key — MockLLM responses |
| [EXAMPLE_RUN_LLM_MODE_ch09_software_dev_agents.ipynb](EXAMPLE_RUN_LLM_MODE_ch09_software_dev_agents.ipynb) | Live LLM | Executed with an OpenAI API key — real GPT responses |
