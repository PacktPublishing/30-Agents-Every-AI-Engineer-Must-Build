...
|---|---|---|
| [EXAMPLE_RUN_SIMULATION_MODE_ch05_foundational_architectures.ipynb](EXAMPLE_RUN_SIMULATION_MODE_ch05_foundational_architectures.ipynb) | Simulation | Executed without an API key — MockLLM responses |
| [EXAMPLE_RUN_LLM_MODE_ch05_foundational_architectures.ipynb](EXAMPLE_RUN_LLM_MODE_ch05_foundational_architectures.ipynb) | Live LLM | Executed with an OpenAI API key — real GPT responses |
