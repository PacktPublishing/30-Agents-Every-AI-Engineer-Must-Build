...
|---|---|---|
| [EXAMPLE_RUN_SIMULATION_MODE_chapter_06_knowledge_agents.ipynb](EXAMPLE_RUN_SIMULATION_MODE_chapter_06_knowledge_agents.ipynb) | Simulation | Executed without an API key — MockLLM responses |
| [EXAMPLE_RUN_LLM_MODE_chapter_06_knowledge_agents.ipynb](EXAMPLE_RUN_LLM_MODE_chapter_06_knowledge_agents.ipynb) | Live LLM | Executed with an OpenAI API key — real GPT responses |
